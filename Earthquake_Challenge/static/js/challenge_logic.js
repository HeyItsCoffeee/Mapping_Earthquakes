...
// We create the outdoors tile layer that will be an option for our map.
...
// We create the tiling layer that will be an option for our map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  L.geoJson(data, {
    ...
    // Create a dictionary of timezone data for each location.
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  console.log("tectonicPlates: ", tectonicPlatesData)
  d3.json(tectonicPlatesData).then(function(data) {
    function styleInfoTectonic() {
      return {
        opacity: 1,
        fillOpacity: 1,
        color: "#FF0000",
